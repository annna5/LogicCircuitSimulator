...
class Visualizer(object):
    ...
    ICONS = ['and.jpg', 'or.jpg', 'nand.jpg', 'nor.jpg', 'buffor.jpg', 'not.jpg', 'xor.jpg', 'switch0.jpg', 'bulb0.jpg', 'knot.jpg']
    ...
    def __init__(self, simulator):
        ...
        left_panel = pygame.Rect(self.V_MARGIN, self.H_MARGIN -4, left_panel_width, main_panel_height)
        ...
        devices_panel = pygame.Rect(self.V_MARGIN + self.SPACE / 2, self.H_MARGIN+4, self.ICON_W, self.ICON_H * len(self.ICONS))
        ...
        start_panel = pygame.Rect(left_panel_width + self.V_MARGIN * 2,\
                                 self.H_MARGIN, main_panel_width, main_panel_height)
        ...
        for i in range(len(self.ICONS)):
            ...
            icon = pygame.image.load(os.path.join(cmd_folder,"icons/"+ self.ICONS[i])).convert()
            self.images.append(icon)

    def draw_background(self):
        """ Draws window background """
        tile_img = pygame.image.load(os.path.join(cmd_folder,"background/2.png")).convert()
    ...
    def draw_icons(self):
        ...
        for i in range(len(self.ICONS)):
            ...
            img_rect.topleft = (self.V_MARGIN + self.SPACE / 2, self.simulator.panels['devices_panel'].top+i * img_rect.height)
    ...
    def draw_start_panel(self):
        ...
        help_img = pygame.image.load(os.path.join(cmd_folder,"background/help.png")).convert()
