...
class Visualizer(object):
    ...
    def __init__(self, simulator):
        ...
        clear_button = pygame.Rect(self.SCREEN_W - self.V_MARGIN - self.BUTTON_W, self.SCREEN_H - self.H_MARGIN - self.BUTTON_H, self.BUTTON_W, self.BUTTON_H)
        print_button = pygame.Rect(self.SCREEN_W - self.V_MARGIN - self.BUTTON_W, self.SCREEN_H - self.H_MARGIN - self.SPACE - self.BUTTON_H * 2, self.BUTTON_W, self.BUTTON_H)
        main_panel_width = self.SCREEN_W  - left_panel_width - self.BUTTON_W - self.V_MARGIN * 4
        main_panel = pygame.Rect(left_panel_width + self.V_MARGIN * 2, self.H_MARGIN, main_panel_width, main_panel_height)
        inside_main_panel = pygame.Rect(main_panel.left + self.ICON_W / 2 + 2, main_panel.top + self.ICON_H / 2 + 2, main_panel_width - self.ICON_W - 2, main_panel_height - self.ICON_H - 2)

        self.simulator.panels = {'main_panel' : main_panel, 'inside_main_panel' : inside_main_panel, 'left_panel' : left_panel, 'devices_panel' : devices_panel, 'clear_button' : clear_button, 'print_button' : print_button}
        self.images = []
    ...
    def draw_buttons(self):
        ...
        clear_button_text = pygame.Rect(self.simulator.panels['clear_button'].left + 4, self.simulator.panels['clear_button'].top + 4, self.BUTTON_W, self.BUTTON_H)
        print_button_text = pygame.Rect(self.simulator.panels['print_button'].left + 4, self.simulator.panels['print_button'].top + 4, self.BUTTON_W, self.BUTTON_H)
